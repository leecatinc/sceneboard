...
Start a new Codex thread after installation. Then create a one-time connection code at [sceneboard.dev](https://sceneboard.dev), send the `SB-...` code to `$sceanboard`, and approve the matching request in SceneBoard.
