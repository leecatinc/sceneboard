...
Redis is disposable coordination only; MySQL/outbox remains durable truth. Live drills require an isolated Redis instance or exact prefix `leecat_board:cert:<manifest-hash>:` under one attempt owner.
