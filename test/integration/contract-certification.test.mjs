...
test('golden manifest is canonical, stable, and exactly reproducible from all 475 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 475);
  assert.equal(result.migrationCount, 32);
  assert.equal(result.sqlAssetCount, 35);
