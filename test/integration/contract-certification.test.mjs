...
test('golden manifest is canonical, stable, and exactly reproducible from all 495 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 495);
  assert.equal(result.migrationCount, 34);
  assert.equal(result.sqlAssetCount, 37);
