...
test('golden manifest is canonical, stable, and exactly reproducible from all 430 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 430);
  assert.equal(result.migrationCount, 19);
  assert.equal(result.sqlAssetCount, 22);
