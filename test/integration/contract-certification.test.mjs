...
test('golden manifest is canonical, stable, and exactly reproducible from all 476 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 476);
  assert.equal(result.migrationCount, 33);
  assert.equal(result.sqlAssetCount, 36);
