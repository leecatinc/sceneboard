...
test('golden manifest is canonical, stable, and exactly reproducible from all 423 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 423);
  assert.equal(result.migrationCount, 18);
  assert.equal(result.sqlAssetCount, 21);
