...
test('golden manifest is canonical, stable, and exactly reproducible from all 450 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 450);
  assert.equal(result.migrationCount, 23);
  assert.equal(result.sqlAssetCount, 26);
