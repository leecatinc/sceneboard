...
test('golden manifest is canonical, stable, and exactly reproducible from all 437 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 437);
  assert.equal(result.migrationCount, 22);
  assert.equal(result.sqlAssetCount, 25);
