...
test('golden manifest is canonical, stable, and exactly reproducible from all 419 closed inputs', async () => {
  ...
  assert.equal(result.resourceCount, 419);
  assert.equal(result.migrationCount, 17);
  assert.equal(result.sqlAssetCount, 20);
