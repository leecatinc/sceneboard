...
const fixture = (): Record<string, unknown> =>
  JSON.parse(
    readFileSync(
      new URL(
        '../../../packages/board-schema/test/fixtures/valid/operation-result-artifact-get.v1.json',
        import.meta.url,
      ),
      'utf8',
    ),
...
test('artifact metadata selector correlates request, pair, and strict operation result', async () => {
  ...
  assert.equal(
    ...
    '/api/v1/boards/board_1/artifacts/artifact_1/versions/version_1',
  );
