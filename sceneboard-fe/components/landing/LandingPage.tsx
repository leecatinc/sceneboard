...
const presentationCapabilities = [
  {
    number: '01',
    titleKey: 'presentation.landingPublicTitle',
    bodyKey: 'presentation.landingPublicBody',
  },
  {
    number: '02',
    titleKey: 'presentation.landingPresentTitle',
    bodyKey: 'presentation.landingPresentBody',
  },
  {
    number: '03',
    titleKey: 'presentation.landingExportTitle',
    bodyKey: 'presentation.landingExportBody',
  },
] as const satisfies ReadonlyArray<{
  number: string;
  titleKey: MessageKey;
      ...
      <div className={styles.scrollArea}>
        <main id="main-content">
          <section className={styles.hero} aria-label={t('presentation.landingHeroAria')}>
            <div className={styles.heroCopy}>
              ...
              <h1 data-locale={locale}>
                {t('presentation.landingTitleBase')}
                <br />
                <span>{t('presentation.landingTitleLead')}</span>
              </h1>
              <p className={styles.heroLead}>{t('presentation.landingLead')}</p>
            ...
            <div
              className={styles.presentationPreview}
              aria-label={t('presentation.landingPreviewAria')}
            >
              <div className={styles.previewChrome}>
                <span className={styles.previewBrand}>SceneBoard</span>
                <span>1 / 6</span>
              </div>
              <div className={styles.previewCanvas}>
                <div className={styles.previewSlides} aria-hidden="true">
                  <span className={styles.previewSlideActive}>01</span>
                  <span>02</span>
                  <span>03</span>
                  <span>04</span>
                </div>
                <div className={styles.previewContent}>
                  <p>{t('presentation.landingPreviewKicker')}</p>
                  <h2>{t('presentation.landingPreviewTitle')}</h2>
                  <div className={styles.previewFlow} aria-hidden="true">
                    <span>LLM</span>
                    <i>→</i>
                    <span>SceneBoard</span>
                    <i>→</i>
                  ...
                  <div className={styles.previewFeatures}>
                    <span>{t('presentation.landingPublicTitle')}</span>
                    <span>{t('presentation.landingPresentTitle')}</span>
                    <span>{t('presentation.landingExportTitle')}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section
            ...
            aria-label={t('presentation.landingCapabilitiesAria')}
          >
            {presentationCapabilities.map((capability) => (
          ...
          <section className={styles.codexStory} aria-label={t('landing.heroAria')}>
            <div className={styles.codexStoryCopy}>
              ...
              <h2>
                {t('landing.heroTitleBase')} <span>{t('landing.heroTitleLead')}</span>
              </h2>
