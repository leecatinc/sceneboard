import type { HitlInteractionV1, HitlRequestId, TimestampV1 } from '@sceneboard/board-schema';
...
export const hitlNotFound = (hitlRequestId: HitlRequestId): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
...
export const hitlIdConflict = (hitlRequestId: HitlRequestId): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
...
export const invalidHitlResponse = (): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
...
export const forbiddenHitlResponse = (): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
    code: 'FORBIDDEN',
...
export const invalidHitlLifecycleCursor = (): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
    code: 'INVALID_PAYLOAD',
...
export const internalHitlFailure = (): BoardContractError =>
  error({
    protocolVersion: 1,
    type: 'board.error',
    code: 'INTERNAL_ERROR',
