...
export const buildMigrationConnectionProfile = (
  ...
  if (input.timeZone !== '+00:00')
    throw new TypeError('migration connection time zone must be +00:00');
  if (input.characterSet !== 'utf8mb4')
    throw new TypeError('migration connection character set must be utf8mb4');
  if (input.collation !== 'utf8mb4_0900_ai_ci')
    throw new TypeError('migration connection collation is invalid');
