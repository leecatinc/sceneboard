...
import type { BoardId, EventId, TimestampV1 } from '@sceneboard/board-schema';
...
const codec = (): SseCursorCodec =>
  new SseCursorCodec(new RedisStreamKeyspace(Buffer.alloc(32, 5)));
