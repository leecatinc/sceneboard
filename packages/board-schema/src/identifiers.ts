...
const globalId = <Name extends string>(_name: Name) => GlobalIdStringSchemaV1.brand<Name>();
...
export const MediaIdSchemaV1 = globalId('MediaId');
...
export const ContentTextSchemaV1 = z
  ...
  .refine(
    ...
    '[LIMIT:maxCodeChars] text is too long',
  );
...
export type MediaId = z.infer<typeof MediaIdSchemaV1>;
