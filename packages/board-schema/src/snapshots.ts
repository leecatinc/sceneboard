...
export const BoardSnapshotSchemaV3 = z
  .object({
    protocolVersion: z.literal(1),
    type: z.literal('board.snapshot'),
    boardId: BoardIdSchemaV1,
...
export type BoardSnapshotV3 = z.infer<typeof BoardSnapshotSchemaV3>;
export type BoardSnapshot = BoardSnapshotV1 | BoardSnapshotV2 | BoardSnapshotV3;
