...
export type BoardStreamCallbacksV1 = {
  replaceSnapshot(snapshot: import('@leecat-board/board-schema').BoardSnapshotV1): void | Promise<void>;
  refreshRevisionSnapshot(event: BoardRevisionHintEnvelopeV1): Promise<BoardRevisionSnapshotAdmissionV1>;
  applyDurableEvent(event: BoardIncrementalDurableEnvelopeV1): void | Promise<void>;
  replacePresence(presence: readonly import('@leecat-board/board-schema').PresenceSummaryV1[]): void | Promise<void>;
