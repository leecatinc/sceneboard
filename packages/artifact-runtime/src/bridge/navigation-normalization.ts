...
export const encodeArtifactCoordinateMillionthV1 = (coordinate: number, extent: number, fallback: number): number => {
...
export const normalizeArtifactWheelDeltaV1 = (deltaY: number, deltaMode: number, innerHeight: number): number | null => {
