...
test('encodes negative, half-step, edge, over-edge, fallback, and large extents exactly', () => {
  ...
  assert.deepEqual(artifactPointerAnchorV1(600, 337.5, Number.NaN, 0), { xMillionth: 500_000, yMillionth: 500_000 });
...
test('round-trip normalization stays within half a millionth of the physical extent', () => {
  for (const [coordinate, extent] of [[1 / 3, 1], [123.456, 1_200], [9_999_999.25, 20_000_000]] as const) {
