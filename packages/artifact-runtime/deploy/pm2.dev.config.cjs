  ...
  apps: [
    {
      ...
      script: '/workspace/lc/leecat-board/packages/artifact-runtime/deploy/launch-dev-runtime.sh',
      interpreter: 'bash',
      cwd: '/workspace/lc/leecat-board',
      autorestart: true,
      max_restarts: 15,
      min_uptime: '20s',
      restart_delay: 4000,
      env: {
        ...
        ARTIFACT_RUNTIME_PUBLIC_DIR:
          '/workspace/lc/leecat-board/packages/artifact-runtime/dist/public',
