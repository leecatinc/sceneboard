import type { BoardNodeV1, BoardSnapshotV1, HitlInteractionV1 } from '@leecat-board/board-schema';
...
export const selectUnplacedOpenHitlV1 = (
  ...
  return snapshot.hitl.filter((interaction) => (
    interaction.state === 'open' && !placed.has(interaction.hitlRequestId)
  ));
};
