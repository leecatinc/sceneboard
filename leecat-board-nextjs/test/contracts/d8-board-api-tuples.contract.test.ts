...
test('D8 publishes exactly five interaction browser selectors', () => {
  assertPublisher({
    ...
    owner: 'D8',
    publisherTestPath: 'leecat-board-nextjs/test/contracts/d8-board-api-tuples.contract.test.ts',
    contractIds: [
      'D8-HITL-MUTATION-REQUEST', 'D8-HITL-MUTATION-RESPOND', 'D8-HITL-READ-WAIT',
      'D8-HITL-LIFECYCLE-CANCEL', 'D8-HITL-LIFECYCLE-SUPERSEDE',
    ],
    memberNames: [
