...
test('D7 publishes exactly the metadata, package, and default-denied broker selectors', () => {
  assertPublisher({
    ...
    owner: 'D7',
    publisherTestPath: 'leecat-board-nextjs/test/contracts/d7-board-api-tuples.contract.test.ts',
    contractIds: ['D7-ARTIFACT-METADATA-GET', 'D7-ARTIFACT-PACKAGE-GET', 'D7-ARTIFACT-NETWORK-FETCH'],
