  ...
  return (
    <div className={styles.requestList}>
      {pairings.map((pairing) => {
        ...
        const permissionCount = pairing.requestedScopes.length + pairing.requestedLifecyclePermissions.length;
        return (
          <button
            type="button"
          ...
          >
            ...
            <span className={styles.permissionCount}>{t('ai.permissionCount', { count: permissionCount })}</span>
