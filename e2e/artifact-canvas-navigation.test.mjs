...
const css = readFileSync(new URL('../leecat-board-nextjs/app/globals.css', import.meta.url), 'utf8');
...
test('fitted canvas scroll geometry exposes only rendered bounds', { timeout: 15_000 }, async (context) => {
  ...
  assert.deepEqual(await page.locator('.artifact-frame-container').evaluate((element) => ({
