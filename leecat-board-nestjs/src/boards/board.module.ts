...
@Module({
  ...
  providers: [
    ...
    MysqlCurrentBoardCapabilitiesPort,
    {
      ...
      useFactory: (environment: AppEnvironment) => new BoardListCursorCodec(environment.cursorMacKey),
    },
    {
    ...
    },
    {
      ...
      inject: [MysqlBoardAccessPolicy],
      useFactory: (accessPolicy: MysqlBoardAccessPolicy) => new BoardCapabilitiesService(accessPolicy),
    },
    {
