...
@Module({
  ...
  providers: [
    ...
    { provide: CurrentHitlSummaryPort, useExisting: CurrentHitlSummaryProvider },
    {
      ...
      inject: [
        MysqlBoardAccessPolicy, InteractionRepository, ControlMutationRepository,
        HitlWaitCoordinator, HitlAuditPolicy,
      ],
      useFactory: (
    ...
    },
    {
      ...
      inject: [
        MysqlService, InteractionRepository, ControlMutationRepository,
        HitlExpiryService, HitlWaitCoordinator,
      ],
      useFactory: (
        mysql: MysqlService,
        interactions: InteractionRepository,
    ...
    },
    {
      ...
      inject: [
        MysqlBoardAccessPolicy, InteractionRepository, ControlMutationRepository,
        HitlExpiryService, HitlWaitCoordinator, HitlAuditPolicy,
      ],
      useFactory: (
        accessPolicy: MysqlBoardAccessPolicy,
        interactions: InteractionRepository,
    ...
    { provide: HitlMutationApplicationPortV1, useExisting: InteractionCommandService },
    {
      ...
      inject: [MysqlBoardAccessPolicy, InteractionRepository, HitlExpiryService, HitlWaitCoordinator],
      useFactory: (
        accessPolicy: MysqlBoardAccessPolicy,
        interactions: InteractionRepository,
        expiry: HitlExpiryService,
    ...
    { provide: HitlQueryApplicationPortV1, useExisting: InteractionQueryService },
    {
      ...
      useFactory: (
        ...
        waits: HitlWaitCoordinator,
        audit: HitlAuditPolicy,
      ) => new InteractionLifecycleService(accessPolicy, interactions, mutations, expiry, waits, audit),
    },
