import type { HitlInteractionV1, RequestId } from '@leecat-board/board-schema';
...
type HitlAuditEventName = Extract<AuditEventName,
...
export class HitlAuditPolicy {
  ...
  async writeSuccess(connection: PoolConnection, input: {
    ...
    await this.audit.writeMandatory({ connection }, {
      ...
      metadata: {
        ...
        impact: input.interaction.definition.kind === 'confirmation'
