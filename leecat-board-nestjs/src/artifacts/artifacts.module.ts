...
@Module({
  ...
  providers: [
    ...
    { provide: CurrentArtifactRuntimeSummaryPort, useExisting: CurrentArtifactRuntimeSummaryProvider },
    {
      provide: ArtifactApplicationService,
      inject: [
        MysqlBoardAccessPolicy, ArtifactSourceNormalizerV1, ArtifactRepository,
        ControlMutationRepository, ArtifactAuditService,
      ],
      useFactory: (
        accessPolicy: MysqlBoardAccessPolicy,
