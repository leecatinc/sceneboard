...
import { RequireSession, type AuthenticatedRequest } from '../common/guards/authentication.guard.js';
...
import { RequirePairingProof, type PairingProofRequest } from '../common/guards/pairing-proof.guard.js';
...
export class PairingController {
  ...
  async claim(
    @Body() input: unknown,
    now: number = Date.now(),
  ): Promise<ClaimedPairingResponse> {
