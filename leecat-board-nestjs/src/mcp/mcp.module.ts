...
import { AUTHORIZED_BROWSER_PRESENCE_PORT_V1, type AuthorizedBrowserPresencePortV1 } from '../presence/ports/authorized-browser-presence.port.js';
...
@Module({
  ...
  providers: [{
    ...
    useFactory: (access: MysqlBoardAccessPolicy, presence: AuthorizedBrowserPresencePortV1) => new McpConnectionService(access, presence),
  }],
