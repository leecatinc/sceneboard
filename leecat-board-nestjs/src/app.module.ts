...
import { D2PostAuthRateLimitGuard, D2PreAuthRateLimitGuard } from './rate-limit/d2-rate-limit.guards.js';
...
@Module({
  imports: [SceneBoardConfigModule, DatabaseModule, PersistenceCertificationModule, RedisModule, AuditModule, AuthModule, RateLimitModule, PairingModule, GrantModule, BoardModule, EventsModule, PresenceModule, McpModule, SseModule],
  providers: [
